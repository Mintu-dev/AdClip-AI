...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex items-center justify-between bg-black/20 backdrop-blur-md border border-white/4 rounded-2xl p-3">
        <Link to="/" onClick={() => scrollTo(0, 0)}>
          <span className="text-white font-bold text-xl">AdClip AI</span>
        </Link>
