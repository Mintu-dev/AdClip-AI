          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="text-left">
              ...
              >
                ...
                <span className="bg-clip-text text-transparent bg-linear-to-r from-purple-400 to-pink-400">
                  into a Viral Ad Video
                </span>
              </motion.h1>

              <motion.p
                className="text-purple-100/80 max-w-lg mb-8"
                initial={{ y: 60, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{
              ...
              <motion.div
                className="flex sm:inline-flex overflow-hidden items-center max-sm:justify-center text-sm text-purple-100 bg-white/5 backdrop-blur-lg border border-purple-500/20 rounded"
                initial={{ y: 60, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{
            ...
            >
              ...
              <div className="mt-4 flex gap-3 items-center justify-start">
                ...
                <motion.div
                  className="text-sm text-purple-200/70 ml-2 flex items-center gap-2"
                  initial={{ y: 60, opacity: 0 }}
                  whileInView={{ y: 0, opacity: 1 }}
                  viewport={{ once: true }}
                  transition={{
